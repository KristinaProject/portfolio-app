      ...
      <div className="wrapper" id="about">
        <div className="text">
          ...
          <p>
            ...
            2021. This is how I ended up on a course for working people in April
            2022. I finished a front-end course at CodeAcademy 480 h in
            ...
            the field grows the employee, I suggest you develop a loyal employee
            and in the future have a colleague who will help you on the job. I
            don't have high requirements for the job. Flexibility of working
            hours is important to me, because I want to combine work and family,
            but I don't like unfinished work. Because of covid I've been working
            from home for more than two years and I've realized that it's
            actually easier to combine work and family, so I'd like to continue
            working from home, but I can come to the office several times a
            week. As for salary, I think it rises with competence in the job.
            Maybe it's you who will offer the dream job?
          </p>
        </div>
        <div id="tools">
          <h2>What I know</h2>
          <ul>
            ...
            <li>
              <img src={javascriptsvg} alt="javascript logo" className="logo" />
            </li>
            <li>
